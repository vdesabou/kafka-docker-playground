...
then
  docker-compose -f ../../environment/mdc-plaintext/docker-compose.yml -f ${DOCKER_COMPOSE_FILE_OVERRIDE} build
  ...
  docker-compose -f ../../environment/mdc-plaintext/docker-compose.yml build
