...
then
  ...
  docker-compose -f ../../environment/plaintext/docker-compose.yml -f ../../environment/ldap_authorizer_sasl_plain/docker-compose.yml -f ${DOCKER_COMPOSE_FILE_OVERRIDE} down -v
  ...
  docker-compose -f ../../environment/plaintext/docker-compose.yml -f ../../environment/ldap_authorizer_sasl_plain/docker-compose.yml down -v
