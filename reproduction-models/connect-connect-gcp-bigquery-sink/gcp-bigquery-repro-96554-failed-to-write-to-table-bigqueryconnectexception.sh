...
# with PR and "bigQueryRetry": 2

# [2022-03-16 13:50:29,466] WARN [gcp-bigquery-sink|task-0] IO Exception: Read timed out, attempting retry (com.wepay.kafka.connect.bigquery.write.row.BigQueryWriter:139)




# [2022-03-16 13:51:32,988] WARN [gcp-bigquery-sink|task-0] IO Exception: Read timed out, attempting retry (com.wepay.kafka.connect.bigquery.write.row.BigQueryWriter:139)

# [2022-03-16 13:52:35,912] WARN [gcp-bigquery-sink|task-0] IO Exception: Read timed out, attempting retry (com.wepay.kafka.connect.bigquery.write.row.BigQueryWriter:139)
# Exception in thread "pool-6-thread-2" com.wepay.kafka.connect.bigquery.exception.BigQueryConnectException: Exceeded configured 2 attempts for write request
# Caused by: Read timed out
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,916] ERROR [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Offset commit failed, rewinding to last committed offsets (org.apache.kafka.connect.runtime.WorkerSinkTask:410)
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,917] INFO [gcp-bigquery-sink|task-0] [Consumer clientId=connector-consumer-gcp-bigquery-sink-0, groupId=connect-gcp-bigquery-sink] Seeking to offset 4 for partition mytopic-0 (org.apache.kafka.clients.consumer.KafkaConsumer:1583)
# [2022-03-16 13:52:35,918] ERROR [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Commit of offsets threw an unexpected exception for sequence number 1: null (org.apache.kafka.connect.runtime.WorkerSinkTask:270)
# com.wepay.kafka.connect.bigquery.exception.BigQueryConnectException: A write thread has failed with an unrecoverable error
# Caused by: Exceeded configured 2 attempts for write request
#         at com.wepay.kafka.connect.bigquery.write.batch.KCBQThreadPoolExecutor.lambda$maybeThrowEncounteredError$0(KCBQThreadPoolExecutor.java:101)
#         at java.base/java.util.Optional.ifPresent(Optional.java:183)
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,926] ERROR [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Task threw an uncaught and unrecoverable exception. Task is being killed and will not recover until manually restarted. Error: A write thread has failed with an unrecoverable error (org.apache.kafka.connect.runtime.WorkerSinkTask:636)
# com.wepay.kafka.connect.bigquery.exception.BigQueryConnectException: A write thread has failed with an unrecoverable error
# Caused by: Exceeded configured 2 attempts for write request
#         at com.wepay.kafka.connect.bigquery.write.batch.KCBQThreadPoolExecutor.lambda$maybeThrowEncounteredError$0(KCBQThreadPoolExecutor.java:101)
#         at java.base/java.util.Optional.ifPresent(Optional.java:183)
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,930] WARN [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Offset commit failed during close (org.apache.kafka.connect.runtime.WorkerSinkTask:408)
# [2022-03-16 13:52:35,930] ERROR [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Commit of offsets threw an unexpected exception for sequence number 2: null (org.apache.kafka.connect.runtime.WorkerSinkTask:270)
# com.wepay.kafka.connect.bigquery.exception.BigQueryConnectException: A write thread has failed with an unrecoverable error
# Caused by: Exceeded configured 2 attempts for write request
#         at com.wepay.kafka.connect.bigquery.write.batch.KCBQThreadPoolExecutor.lambda$maybeThrowEncounteredError$0(KCBQThreadPoolExecutor.java:101)
#         at java.base/java.util.Optional.ifPresent(Optional.java:183)
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,932] ERROR [gcp-bigquery-sink|task-0] WorkerSinkTask{id=gcp-bigquery-sink-0} Task threw an uncaught and unrecoverable exception. Task is being killed and will not recover until manually restarted (org.apache.kafka.connect.runtime.WorkerTask:206)
# org.apache.kafka.connect.errors.ConnectException: Exiting WorkerSinkTask due to unrecoverable exception.
#         at org.apache.kafka.connect.runtime.WorkerSinkTask.deliverMessages(WorkerSinkTask.java:638)
#         at org.apache.kafka.connect.runtime.WorkerSinkTask.poll(WorkerSinkTask.java:334)
#         at org.apache.kafka.connect.runtime.WorkerSinkTask.iteration(WorkerSinkTask.java:235)
...
#         at com.google.cloud.bigquery.spi.v2.HttpBigQueryRpc.insertAll(HttpBigQueryRpc.java:487)
#         ... 12 more
# [2022-03-16 13:52:35,943] INFO [gcp-bigquery-sink|task-0] [Consumer clientId=connector-consumer-gcp-bigquery-sink-0, groupId=connect-gcp-bigquery-sink] Revoke previously assigned partitions mytopic-0 (org.apache.kafka.clients.consumer.internals.ConsumerCoordinator:310)
# [2022-03-16 13:52:35,943] INFO [gcp-bigquery-sink|task-0] [Consumer clientId=connector-consumer-gcp-bigquery-sink-0, groupId=connect-gcp-bigquery-sink] Member connector-consumer-gcp-bigquery-sink-0-89a8dd72-a10b-461b-8629-3bad6f44f953 sending LeaveGroup request to coordinator broker:9092 (id: 2147483646 rack: null) due to the consumer is being closed (org.apache.kafka.clients.consumer.internals.ConsumerCoordinator:1048)
# [2022-03-16 13:52:35,944] INFO [gcp-bigquery-sink|task-0] [Consumer clientId=connector-consumer-gcp-bigquery-sink-0, groupId=connect-gcp-bigquery-sink] Resetting generation due to: consumer pro-actively leaving the group (org.apache.kafka.clients.consumer.internals.ConsumerCoordinator:966)
# [2022-03-16 13:52:35,945] INFO [gcp-bigquery-sink|task-0] [Consumer clientId=connector-consumer-gcp-bigquery-sink-0, groupId=connect-gcp-bigquery-sink] Request joining group due to: consumer pro-actively leaving the group (org.apache.kafka.clients.consumer.internals.ConsumerCoordinator:988)
# [2022-03-16 13:52:35,949] INFO [gcp-bigquery-sink|task-0] Publish thread interrupted for client_id=connector-consumer-gcp-bigquery-sink-0 client_type=CONSUMER session= cluster=OoPnRo9zSYyrX0hyav_XVQ group=connect-gcp-bigquery-sink (io.confluent.monitoring.clients.interceptor.MonitoringInterceptor:285)
# [2022-03-16 13:52:35,950] INFO [gcp-bigquery-sink|task-0] Publishing Monitoring Metrics stopped for client_id=connector-consumer-gcp-bigquery-sink-0 client_type=CONSUMER session= cluster=OoPnRo9zSYyrX0hyav_XVQ group=connect-gcp-bigquery-sink (io.confluent.monitoring.clients.interceptor.MonitoringInterceptor:297)
# [2022-03-16 13:52:35,951] INFO [gcp-bigquery-sink|task-0] [Producer clientId=confluent.monitoring.interceptor.connector-consumer-gcp-bigquery-sink-0] Closing the Kafka producer with timeoutMillis = 9223372036854775807 ms. (org.apache.kafka.clients.producer.KafkaProducer:1208)