...
public class SimpleProducer {
    ...
    private void start() throws InterruptedException {
        ...
        try (Producer<String, Customer> producer = new KafkaProducer<>(properties)) {
            ...
            while (id < nbMessages) {
                ...
                String mykey = "Struct{usr_user_id=";
                mykey += id;
                mykey += "}";

                ProducerRecord<String, Customer> record = new ProducerRecord<>(topicName, mykey, customer);
    ...
    private void sendCallback(ProducerRecord<String, Customer> record, RecordMetadata recordMetadata, Exception e) {
        if (e == null) {
