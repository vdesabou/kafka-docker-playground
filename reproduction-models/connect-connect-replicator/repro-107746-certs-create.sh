...
for i in broker broker2 broker3 client schema-registry restproxy connect connect2 connect3 control-center clientrestproxy ksqldb-server broker-other schema-registry-other connect-other
do
    echo "------------------------------- $i -------------------------------"
