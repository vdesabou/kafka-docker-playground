...
${DIR}/../../environment/plaintext/start.sh "${PWD}/docker-compose.plaintext.generalized.repro-104362-error-500-timeout-when-posting-connector.yml"
...
#      echo "${i}"
#      cp generalized.quickstart.json /tmp/tmp/generalized.quickstart$i.json
# done
