...
${DIR}/../../reproduction-models/ccloud-environment/start.sh "${PWD}/docker-compose-executable-onprem-to-cloud-topicrecordnamestrategy.yml" -a -b
...
docker-compose -f ../../reproduction-models/ccloud-environment/docker-compose.yml -f ${PWD}/docker-compose-executable-onprem-to-cloud-topicrecordnamestrategy.yml -f docker-compose-executable-onprem-to-cloud-avro.yml up -d
