...
${DIR}/../../environment/plaintext/start.sh "${PWD}/docker-compose.plaintext.repro-103276-xml-payload-only.yml"
...
export CLASSPATH
javac *.java
java tibjmsMsgProducer -user admin -queue connector-quickstart "<Testing><XML><Values><ID value="DUNS">45454546</ID></Values></XML></Testing>"'
...
# <Testing><XML><Values><ID value=DUNS>45454546</ID></Values></XML></Testing>
