...
# [2022-03-29 12:45:23,851] WARN [cdc-oracle-source-cdb|task-1|changeEvent] Encountered unparsable statement: insert into "C##MYUSER"."CUSTOMERS"("ID","FIRST_NAME","LAST_NAME","EMAIL","GENDER","CLUB_STATUS","COMMENTS","CREATE_TS","UPDATE_TS","COUNTRY") values ('64','Rica3','Blaisde32','rblaisdell30@rambler.ru\','Female3','bronze3','Universal optimal hierarchy3',TO_TIMESTAMP('2022-03-29 12:45:18.442'),TO_TIMESTAMP('2022-03-29 12:45:18.000'),NULL);. Logging and continuing (io.confluent.connect.oracle.cdc.record.OracleChangeEventSourceRecordConverter:341)
