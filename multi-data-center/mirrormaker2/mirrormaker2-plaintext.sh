...
timeout 60 docker container exec broker-europe kafka-console-consumer --bootstrap-server broker-europe:9092 --topic "US.sales_US" --from-beginning --max-messages 10
