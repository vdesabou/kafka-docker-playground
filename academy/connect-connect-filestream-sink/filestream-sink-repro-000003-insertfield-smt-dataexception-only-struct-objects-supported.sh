...
playground start-environment --environment plaintext --docker-compose-override-file "${PWD}/docker-compose.plaintext.repro-000003-insertfield-smt-dataexception-only-struct-objects-supported.yml"
