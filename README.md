...
| <img src="./images/icons/activemq.png" width="15"> [ActiveMQ Source](connect/connect-active-mq-source)  | Message Queue  | 5.5.1 | Confluent Subscription | 2020-06-25 
...
| <img src="./images/icons/dynamodb.svg" width="15"> [Amazon DynamoDB Sink](connect/connect-aws-dynamodb-sink) | Database  | 1.1.1 | Confluent Subscription | 2020-08-20 
| <img src="./images/icons/kinesis.svg" width="15"> [Amazon Kinesis Source](connect/connect-aws-kinesis-source) | Message Queue  | 1.1.10 | Confluent Subscription | 2020-08-26 
...
| <img src="./images/icons/aws_redshift.png" width="15"> [Amazon Redshift Source](connect/connect-jdbc-aws-redshift-source) (using JDBC) | Data Warehouse  | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/s3.png" width="15"> [Amazon S3 Sink](connect/connect-aws-s3-sink) | Datastore  | 5.5.1 | Confluent Community License | 2020-06-25 
...
| <img src="./images/icons/sqs.svg" width="15"> [Amazon SQS Source](connect/connect-aws-sqs-source)  | Message Queue  | 1.0.5 | Confluent Subscription | 2020-07-31 
...
| <img src="./images/icons/data_lake_gen1.png" width="15"> [Azure Data Lake Storage Sink (Gen1)](connect/connect-azure-data-lake-storage-gen1-sink)  | Datastore | 1.4.0 | Confluent Subscription | 2020-07-24 
| <img src="./images/icons/data_lake_gen1.png" width="15"> [Azure Data Lake Storage Sink (Gen2)](connect/connect-azure-data-lake-storage-gen2-sink)  | Datastore | 1.4.0 | Confluent Subscription | 2020-07-24 
...
| <img src="./images/icons/search.png" width="15"> [Azure Search Sink](connect/connect-azure-search-sink)  | Analytics | 1.0.1 | Confluent Subscription | 2020-01-07 
...
| <img src="./images/icons/sql_data_warehouse.png" width="15"> [Azure SQL Data Warehouse Sink](connect/connect-azure-sql-data-warehouse-sink)  | Data Warehouse | 1.0.3 | Confluent Subscription | 2020-04-24 
...
| <img src="./images/icons/sql_server.png" width="15"> [Debezium CDC Microsoft SQL Server Source](connect/connect-debezium-sqlserver-source)  | CDC | 1.2.2 | Open Source (Debezium Community) | null 
| <img src="./images/icons/mysql.jpg" width="15"> [Debezium CDC MySQL Source](connect/connect-debezium-mysql-source)  | CDC | 1.2.2 | Open Source (Debezium Community) | null 
| <img src="./images/icons/postgresql.png" width="15"> [Debezium CDC PostgreSQL Source](connect/connect-debezium-postgresql-source)  | CDC | 1.2.2 | Open Source (Debezium Community) | null 
| <img src="./images/icons/mongodb.jpg" width="15"> [Debezium CDC MongoDB Source](connect/connect-debezium-mongodb-source)  | CDC | 1.2.2 | Open Source (Debezium Community) | null 
...
| <img src="https://static-dotconferences-com.s3.amazonaws.com/editionpartnerships/datadog.png" height="15"> [Datadog Metrics Sink](connect/connect-datadog-metrics-sink) | Analytics | 1.1.2 | Confluent Subscription | 2020-06-08 
| <img src="./images/icons/elasticsearch.png" width="15"> [ElasticSearch Sink](connect/connect-elasticsearch-sink) | Analytics | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/ftps.png" height="15"> [FTPS Sink](connect/connect-ftps-sink) | Datastore |1.0.1-preview | Confluent Subscription | 2020-07-10 
| <img src="./images/icons/ftps.png" height="15"> [FTPS Source](connect/connect-ftps-source) | Datastore |1.0.1-preview | Confluent Subscription | 2020-07-10 
| <img src="./images/icons/pivotal_gemfire.png" width="15"> [Gemfire](connect/connect-pivotal-gemfire-sink) | Database | 1.0.1 | Confluent Subscription | 2019-11-19 
| <img src="./images/icons/github.png" width="15"> [Github](connect/connect-github-source) | SaaS Apps | 1.0.1 | Confluent Subscription | 2020-06-05 
| <img src="./images/icons/bigquery.png" width="15"> [Google BigQuery Sink](connect/connect-gcp-bigquery-sink) | Data Warehouse | 1.6.1 | Open Source (WePay) | null 
| <img src="./images/icons/cloud_functions.png" width="15"> [Google Cloud Functions](connect/connect-gcp-cloud-functions-sink) | SaaS Apps | 1.0.6 | Confluent Subscription | 2020-01-15 
...
| <img src="./images/icons/hdfs_2.svg" width="15"> [HDFS 2 Sink](connect/connect-hdfs2-sink) |  Datastore | 5.5.1 | Confluent Community License | 2020-06-25 
...
| <img src="./images/icons/ibm_mq.png" width="15"> [IBM MQ Sink](connect/connect-ibm-mq-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
| <img src="./images/icons/ibm_mq.png" width="15"> [IBM MQ Source](connect/connect-ibm-mq-source) |  Message Queue | 5.5.1 | Confluent Subscription | 2020-06-25 
| <img src="./images/icons/influxdb.svg" width="15"> [InfluxDB Sink](connect/connect-influxdb-sink) |  Database | 1.2.0 | Confluent Subscription | 2020-07-13 
| <img src="./images/icons/influxdb.svg" width="15"> [InfluxDB Source](connect/connect-influxdb-source) |  Database | 1.2.0 | Confluent Subscription | 2020-07-13 
| <img src="./images/icons/hive.png" width="15"> [JDBC Hive Sink](connect/connect-jdbc-hive-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/mysql.jpg" width="15"> [JDBC MySQL Sink](connect/connect-jdbc-mysql-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/oracle_11.jpg" width="15"> [JDBC Oracle 11 Sink](connect/connect-jdbc-oracle11-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/oracle_12.jpg" width="15"> [JDBC Oracle 12 Sink](connect/connect-jdbc-oracle11-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/postgresql.png" width="15"> [JDBC PostGreSQL Sink](connect/connect-jdbc-postgresql-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/sql_server.png" width="15"> [JDBC Microsoft SQL Server Sink](connect/connect-jdbc-sqlserver-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/vertica.png" width="15"> [JDBC Vertica Sink](connect/connect-jdbc-vertica-sink) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/mysql.jpg" width="15"> [JDBC MySQL Source](connect/connect-jdbc-mysql-source) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/oracle_11.jpg" width="15"> [JDBC Oracle 11 Source](connect/connect-jdbc-oracle11-source) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/oracle_12.jpg" width="15"> [JDBC Oracle 12 Source](connect/connect-jdbc-oracle11-source) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/postgresql.png" width="15"> [JDBC PostGreSQL Source](connect/connect-jdbc-postgresql-source) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
| <img src="./images/icons/sql_server.png" width="15"> [JDBC Microsoft SQL Server Source](connect/connect-jdbc-sqlserver-source) |  Database | 5.5.1 | Confluent Community License | 2020-06-25 
...
| <img src="./images/icons/activemq.png" width="15"> [JMS ActiveMQ Sink](connect/connect-jms-active-mq-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
| <img src="./images/icons/solace.jpg" width="15"> [JMS Solace Sink](connect/connect-jms-solace-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
| <img src="./images/icons/tibco_ems.png" width="15"> [JMS TIBCO EMS Sink](connect/connect-jms-tibco-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
| <img src="./images/icons/tibco_ems.png" width="15"> [JMS TIBCO EMS Source](connect/connect-jms-tibco-source) |  Message Queue | 5.5.1 | Confluent Subscription | 2020-06-25 
| <img src="./images/icons/minio.png" height="15"> [Minio Sink](connect/connect-minio-s3-sink) |  Datastore | 5.5.1 | Confluent Community License | 2020-06-25 
...
| <img src="./images/icons/neo4j.png" width="15"> [Neo4j Sink](connect/connect-neo4j-sink) |  Database | 1.0.7 | Open Source (Neo4j, Inc.) | 2020-04-02 
...
| <img src="./images/icons/rabbitmq.svg" width="15"> [RabbitMQ Sink](connect/connect-rabbitmq-sink) |  Message Queue | 1.3.0-preview | Confluent Subscription | 2020-06-09 
| <img src="./images/icons/rabbitmq.svg" width="15">  [RabbitMQ Source](connect/connect-rabbitmq-source) |  Message Queue | 1.3.0 | Confluent Subscription | 2020-06-09 
| <img src="./images/icons/redis.jpg" width="15"> [Redis](connect/connect-redis-sink) |  Database | 0.0.2.11 | Open Source (Jeremy Custenborder) | 2020-01-22 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce Bulk API Sink](connect/connect-salesforce-bulkapi-sink) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce Bulk API Source](connect/connect-salesforce-bulkapi-source) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce CDC Source](connect/connect-salesforce-cdc-source) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce Platform Events Sink](connect/connect-salesforce-platform-events-sink) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce Platform Events Source](connect/connect-salesforce-platform-events-source) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce PushTopics Source](connect/connect-salesforce-pushtopics-source) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
| <img src="./images/icons/salesforce.png" height="15"> [SalesForce SObject Sink](connect/connect-salesforce-sobject-sink) |  SaaS Apps | 1.6.5 | Confluent Subscription | 2020-08-27 
...
| <img src="./images/icons/sftp.png" width="15"> [SFTP Sink](connect/connect-sftp-sink) |  Datastore | 2.1.0 | Confluent Subscription | 2020-08-18 
| <img src="./images/icons/sftp.png" width="15"> [SFTP Sink](connect/connect-sftp-source) |  Datastore | 2.1.0 | Confluent Subscription | 2020-08-18 
| <img src="./images/icons/snmp_trap.png" width="15"> [SNMP Trap](connect/connect-snmp-source) |  IoT | 1.1.2 | Confluent Subscription | 2020-04-09 
| <img src="./images/icons/snowflake.png" height="15">  [Snowflake](connect/connect-snowflake-sink) |  Data Warehouse | 1.4.3 | Open Source (Snowflake, Inc.) | 2020-08-05 
| <img src="./images/icons/solace.jpg" width="15"> [Solace Sink](connect/connect-solace-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
...
| <img src="./images/icons/splunk.jpg" width="15"> [Splunk Sink](connect/connect-splunk-sink) |  Analytics | 1.2.0 | Open Source (Splunk) | null 
...
| <img src="./images/icons/tibco_ems.png" width="15"> [TIBCO EMS Sink](connect/connect-tibco-sink) |  Message Queue | 1.2.0 | Confluent Subscription | 2020-08-26 
...
| <img src="./images/icons/vertica.png" width="15"> [Vertica Sink](connect/connect-vertica-sink) |  Database | 1.2.1 | Confluent Subscription | 2020-07-24 
