...
do
    ...
    cp "${PWD}/${component}"/target/awscredentialsprovider-1.0.0-jar-with-dependencies.jar ../../confluent-hub/confluentinc-kafka-connect-kinesis/lib/awscredentialsprovider-1.0.0-jar-with-dependencies.jar
    set -e
done
