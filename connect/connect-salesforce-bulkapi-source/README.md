...
```
$ playground run -f salesforce-bukapi-source<use tab key to activate fzf completion (see https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion), otherwise use full path, or relative path> <SALESFORCE_USERNAME> <SALESFORCE_PASSWORD> <SALESFORCE_SECURITY_TOKEN>
```
