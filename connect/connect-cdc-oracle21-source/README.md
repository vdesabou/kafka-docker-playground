...
```
$ just use <playground run> command and search for cdc-oracle21-cdb-table.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle21-pdb-table.sh in this folder
```

with SSL encryption:

```
$ just use <playground run> command and search for cdc-oracle21-cdb-table-ssl.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle21-pdb-table-ssl.sh in this folder
```
...
```
$ just use <playground run> command and search for cdc-oracle21-cdb-table-mtls.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle21-pdb-table-mtls.sh in this folder
```
...
```
$ just use <playground run> command and search for cdc-oracle21-cdb-table-mtls-db-auth.sh in this folder
```
