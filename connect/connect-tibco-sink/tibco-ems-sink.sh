...
if [ ! -f ../../connect/connect-tibco-sink/tibjms.jar ]
then
     log "../../connect/connect-tibco-sink/tibjms.jar missing, will get it from ../../connect/connect-tibco-sink/docker-tibco/TIB_ems-ce_8.5.1_linux_x86_64.zip"
     rm -rf /tmp/TIB_ems-ce_8.5.1
     unzip ../../connect/connect-tibco-sink/docker-tibco/TIB_ems-ce_8.5.1_linux_x86_64.zip -d /tmp/
     ...
     cp ../../connect/connect-tibco-sink/opt/tibco/ems/8.5/lib/tibjms.jar ../../connect/connect-tibco-sink/
     cp ../../connect/connect-tibco-sink/opt/tibco/ems/8.5/lib/jms-2.0.jar ../../connect/connect-tibco-sink/
     rm -rf ../../connect/connect-tibco-sink/opt
fi
...
cd ../../connect/connect-tibco-sink

# Copy JAR files to confluent-hub
mkdir -p ../../confluent-hub/confluentinc-kafka-connect-tibco-sink/lib/
cp ../../connect/connect-tibco-sink/tibjms.jar ../../confluent-hub/confluentinc-kafka-connect-tibco-sink/lib/tibjms.jar
cd -
