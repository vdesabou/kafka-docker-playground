...
docker cp sftp-server:/home/foo/upload/topics/test_sftp_sink/partition\=0/test_sftp_sink+0+0000000000.  /tmp/

docker run -v /tmp:/tmp actions/ -tools tojson /tmp/test_sftp_sink+0+0000000000.