...
```
$ playground run -f oracle21-sink<tab>
```

with SSL encryption:

```
$ playground run -f oracle21-sink-ssl<tab>
```
...
```
$ playground run -f oracle21-sink-mtls<tab>
```
...
```
$ playground run -f oracle21-sink-mtls-db-auth<tab>
```
