...
docker exec connect \
     ...
     --data '{
               ...
               "logs.dir":"/tmp",
               "topics.dir":"${5}/landing/behavioral",
               "topic.regex.capture.group": "[a-zA-Z0-9-]*",
...
echo "Sending messages to topic tracking.mmtro.navigation.client.clientA.enabled "
...
echo "Sending messages to topic tracking.mmtro.navigation.client.clientB.enabled "
...
echo "Sending messages to topic tracking.mmtro.navigation.client.client123.enabled "
...
echo "Sending messages to topic tracking.mmtro.navigation.client.client-C.enabled "
...
echo "Listing content of /clientA/landing/behavioral in HDFS"
...
echo "Listing content of /clientB/landing/behavioral in HDFS"
...
echo "Listing content of /client123/landing/behavioral in HDFS"
...
echo "Listing content of /client-C/landing/behavioral in HDFS"
