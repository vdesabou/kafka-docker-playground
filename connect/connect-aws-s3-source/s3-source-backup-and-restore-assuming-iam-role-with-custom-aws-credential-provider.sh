...
do
    ...
    cp "${PWD}/${component}"/target/awscredentialsprovider-1.0.0-jar-with-dependencies.jar ../../confluent-hub/confluentinc-kafka-connect-s3-source/lib/awscredentialsprovider-1.0.0-jar-with-dependencies.jar
    cp "${PWD}/${component}"/target/awscredentialsprovider-1.0.0-jar-with-dependencies.jar ../../confluent-hub/confluentinc-kafka-connect-s3/lib/awscredentialsprovider-1.0.0-jar-with-dependencies.jar
    set -e
done
