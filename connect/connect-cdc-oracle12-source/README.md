...
```
$ playground run -f cdc-oracle12-cdb-table<tab>
```

or

```
$ playground run -f cdc-oracle12-pdb-table<tab>
```

with SSL encryption:

```
$ playground run -f cdc-oracle12-cdb-table-ssl<tab>
```

or

```
$ playground run -f cdc-oracle12-pdb-table-ssl<tab>
```
...
```
$ playground run -f cdc-oracle12-cdb-table-mtls<tab>
```

or

```
$ playground run -f cdc-oracle12-pdb-table-mtls<tab>
```
...
```
$ playground run -f cdc-oracle12-cdb-table-mtls-db-auth<tab>
```
