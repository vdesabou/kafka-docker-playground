...
if [ ! -d ${DIR}/confluentinc-kafka-connect-oracle-cdc-1.0.0-rc-0463ef7-preview ]
then
     logerror "ERROR: ${DIR}/confluentinc-kafka-connect-oracle-cdc-1.0.0-rc-0463ef7-preview is missing."
     exit 1
fi
