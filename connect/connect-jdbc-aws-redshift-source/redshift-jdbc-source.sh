...
cd ../../connect/connect-jdbc-aws-redshift-source

# Copy JAR files to confluent-hub
mkdir -p ../../confluent-hub/confluentinc-kafka-connect-jdbc/lib/
cp ../../connect/connect-jdbc-aws-redshift-source/redshift-jdbc42-2.1.0.17/redshift-jdbc42-2.1.0.17.jar ../../confluent-hub/confluentinc-kafka-connect-jdbc/lib/redshift-jdbc42-2.1.0.17.jar
cd -
