...
log "Trigger Ad hoc snapshot via signal topic"
# playground container exec -i sqlserver /opt/mssql-tools18/bin/sqlcmd -C -No -U sa -P Password! << EOF
# USE testDB;
...
{"id": "captain adhoc 1","type":"execute-snapshot","data": {"data-collections": ["testDB.dbo.customers2"], "type": "INCREMENTAL"}}
EOF
