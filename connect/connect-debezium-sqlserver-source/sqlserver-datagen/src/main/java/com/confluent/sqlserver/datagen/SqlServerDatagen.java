package com.confluent.sqlserver.datagen;

import com.beust.jcommander.JCommander;
import com.confluent.sqlserver.datagen.connection.SqlServerDatabase;
...
public class SqlServerDatagen {

    private static final Logger log = LogManager.getLogger(SqlServerDatagen.class);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ...
        SqlServerDatabase database = new SqlServerDatabase(params);
