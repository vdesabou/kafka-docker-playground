...
then
     ...
     cp ../../connect/connect-jms-tibco-sink/opt/tibco/ems/8.5/lib/jms-2.0.jar ../../connect/connect-jms-tibco-sink/
...
cd ../../connect/connect-jms-tibco-sink

# Copy JAR files to confluent-hub
mkdir -p ../../confluent-hub/confluentinc-kafka-connect-jms-sink/lib/
cp ../../connect/connect-jms-tibco-sink/tibjms.jar ../../confluent-hub/confluentinc-kafka-connect-jms-sink/lib/tibjms.jar
cd -
