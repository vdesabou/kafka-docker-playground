...
if [ ! -z "$TAG_BASE" ] && version_gt $TAG_BASE "7.9.99" && [ ! -z "$CONNECTOR_TAG" ] && ! version_gt $CONNECTOR_TAG "1.2.4"
then
     logwarn "minimal supported connector version is 1.2.5 for CP 8.0"
