...
echo "Creating GCP Firebase Sink connector"
...
echo "Produce Avro data to topic artists"
...
echo "Produce Avro data to topic songs"
...
echo "Follow README to verify data is in Firebase"
