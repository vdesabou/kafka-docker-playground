...
docker run -v $PWD:/tmp vdesabou/kafka-docker-playground-connect:${TAG} openssl req -x509 -nodes -days 365 -newkey rsa:1024 -keyout /tmp/vsftpd.pem -out /tmp/vsftpd.pem  -config /tmp/cert_config -reqexts 'my server exts'
