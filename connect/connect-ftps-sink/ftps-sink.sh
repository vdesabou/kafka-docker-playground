...
playground container cp --source ftps-server:/home/vsftpd/bob/test_ftps_sink/partition\=0/test_ftps_sink+0+0000000000.avro --destination /tmp/test_ftps_sink+0+0000000000.avro
