...
cd ../../connect/connect-jms-weblogic-source

# Copy JAR files to confluent-hub
mkdir -p ../../confluent-hub/confluentinc-kafka-connect-jms/lib/
cp ../../connect/connect-jms-weblogic-source/jms-sender/lib/wlthint3client.jar ../../confluent-hub/confluentinc-kafka-connect-jms/lib/wlthint3client.jar
cd -
