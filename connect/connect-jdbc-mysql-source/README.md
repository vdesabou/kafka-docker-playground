...
```
$ just use <playground run> command and search for mysql.sh in this folder
```

with SSL encryption:

```
$ just use <playground run> command and search for mysql-ssl.sh in this folder
```

with SSL encryption + Mutual TLS authentication:

```
$ just use <playground run> command and search for mysql-mtls.sh in this folder
```
