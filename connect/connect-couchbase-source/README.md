...
```
$ just use <playground run> command and search for couchbase-with-key-filter.sh in this folder
```
...
```
$ just use <playground run> command and search for couchbase-with-transforms.sh in this folder
```
