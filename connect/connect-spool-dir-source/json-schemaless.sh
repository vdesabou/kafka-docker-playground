...
log "Generate data"
playground --output-level WARN container exec --container connect --command "mkdir -p /tmp/data/input/ && mkdir -p /tmp/data/error/ && mkdir -p /tmp/data/finished/ && curl -k \"https://api.mockaroo.com/api/17c84440?count=10&key=25fd9c80\" > /tmp/data/input/json-spooldir-source.json"
