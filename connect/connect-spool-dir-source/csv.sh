...
log "Generate data"
playground --output-level WARN container exec --container connect --command "mkdir -p /tmp/data/input/ && mkdir -p /tmp/data/error/ && mkdir -p /tmp/data/finished/ && curl -k \"https://api.mockaroo.com/api/58605010?count=1000&key=25fd9c80\" > /tmp/data/input/csv-spooldir-source.csv"
