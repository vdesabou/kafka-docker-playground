...
```
$ playground run -f oracle19-sink<tab>
```

with SSL encryption:

```
$ playground run -f oracle19-sink-ssl<tab>
```
...
```
$ playground run -f oracle19-sink-mtls<tab>
```
...
```
$ playground run -f oracle19-sink-mtls-db-auth<tab>
```
