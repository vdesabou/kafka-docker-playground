...
docker exec connect \
     ...
     --data '{
               "connector.class" : "io.confluent.vertica.VerticaSinkConnector",
                    ...
                    "topics": "customer1,customer2",
                    "enable.auto.commit": "false",
                    "transforms": "TombstoneToNull, insert_dwhCreateDate, KeyToValue, cast_kafkaId_toInt, insertTopicInMyTableField, mapMyTableFieldToTopic",
                    ...
                    "transforms.insertTopicInMyTableField.type": "org.apache.kafka.connect.transforms.InsertField$Value",
                    "transforms.insertTopicInMyTableField.topic.field": "MyTable",
