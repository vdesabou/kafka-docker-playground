...
docker exec -i postgres psql -U myuser -d postgres << EOF
insert into customers (id, first_name, last_name, email, gender, comments,create_ts) values (27, '26Bernardo', '2Dudman', 'bdudmanb@lulu.com', 'Male', 'Robust bandwidth-monitored budgetary management','2022-04-02 00:00:00+00');
EOF
...
docker exec -i postgres psql -U myuser -d postgres << EOF
insert into customers (id, first_name, last_name, email, gender, comments,create_ts) values (28, '28Bernardo', '28Dudman', 'bdudmanb@lulu.com', 'Male', 'Robust bandwidth-monitored budgetary management','2022-03-02 00:00:00+00');
insert into customers (id, first_name, last_name, email, gender, comments,create_ts) values (29, '29Bernardo', '29Dudman', 'bdudmanb@lulu.com', 'Male', 'Robust bandwidth-monitored budgetary management','2022-02-02 00:00:00+00');
update customers set first_name = '291Bernardo' where id = 29;
EOF


log "Verifying topic asgard.public.customers-raw"
timeout 60 docker exec connect kafka-avro-console-consumer -bootstrap-server broker:9092 --property schema.registry.url=http://schema-registry:8081 --topic asgard.public.customers-raw --from-beginning --property print.key=true --max-messages 24
