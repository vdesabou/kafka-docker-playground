...
```
$ just use <playground run> command and search for mongo-source.sh in this folder
```

or with SSL encryption:

```
$ just use <playground run> command and search for mongo-source-ssl.sh in this folder
```
