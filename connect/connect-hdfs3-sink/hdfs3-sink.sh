...
playground container exec --container namenode --command "bash -c \"/opt/hadoop-3.1.3/bin/hdfs dfs -ls /topics/hdfs-topic/partition=0\""

log "Getting one of the avro files locally and displaying content with avro-tools"
playground container exec --container namenode --command "bash -c \"/opt/hadoop-3.1.3/bin/hadoop fs -copyToLocal /topics/hdfs-topic/partition=0/hdfs-topic+0+0000000000+0000000002.avro /tmp\""
