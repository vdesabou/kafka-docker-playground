...
#docker exec namenode1 bash -c "echo password | kinit -kt /opt/hadoop/etc/hadoop/nn.keytab nn/namenode1.kerberos-demo.local && /opt/hadoop/bin/hdfs dfs -chmod 777  /"
...
curl -X PUT \
     ...
     --data '{
               ...
               "tasks.max":"1",
               "topics":"test_hdfs",
               "store.url":"hdfs://namenode1.kerberos-demo.local:8020",
               "flush.size":"3",
