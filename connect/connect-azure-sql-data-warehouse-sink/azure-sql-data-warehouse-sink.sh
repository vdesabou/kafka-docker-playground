...
AZURE_SQL_NAME=playground$USER$TRAVIS_JOB_NUMBER
AZURE_FIREWALL_RULL_NAME=playground$USER$TRAVIS_JOB_NUMBER
AZURE_DATA_WAREHOUSE_NAME=playground$USER$TRAVIS_JOB_NUMBER
