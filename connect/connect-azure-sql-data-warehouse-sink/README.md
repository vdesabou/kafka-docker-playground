...
AZURE_SQL_NAME=playground$USER$TRAVIS_BUILD_NUMBER
AZURE_FIREWALL_RULL_NAME=playground$USER$TRAVIS_BUILD_NUMBER
AZURE_DATA_WAREHOUSE_NAME=playground$USER$TRAVIS_BUILD_NUMBER
