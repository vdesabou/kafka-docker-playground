...
```
$ just use <playground run> command and search for oracle19.sh in this folder
```

with SSL encryption:

```
$ just use <playground run> command and search for oracle19-ssl.sh in this folder
```
...
```
$ just use <playground run> command and search for oracle19-mtls.sh in this folder
```
...
```
$ just use <playground run> command and search for oracle19-mtls-db-auth.sh in this folder
```
