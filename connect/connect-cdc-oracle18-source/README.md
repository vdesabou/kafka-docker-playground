...
```
$ just use <playground run> command and search for cdc-oracle18-cdb-table.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle18-pdb-table.sh in this folder
```

with SSL encryption:

```
$ just use <playground run> command and search for cdc-oracle18-cdb-table-ssl.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle18-pdb-table-ssl.sh in this folder
```
...
```
$ just use <playground run> command and search for cdc-oracle18-cdb-table-mtls.sh in this folder
```

or

```
$ just use <playground run> command and search for cdc-oracle18-pdb-table-mtls.sh in this folder
```
...
```
$ just use <playground run> command and search for cdc-oracle18-cdb-table-mtls-db-auth.sh in this folder
```
...
SSL_CLIENT_AUTHENTICATION = FALSE
SSL_CIPHER_SUITES = (SSL_ECDHE_RSA_WITH_AES_256_GCM_SHA384, SSL_DHE_RSA_WITH_AES_256_GCM_SHA384, SSL_ECDHE_RSA_WITH_AES_128_GCM_SHA256, SSL_DHE_RSA_WITH_AES_128_GCM_SHA256, SSL_RSA_WITH_AES_256_GCM_SHA384, SSL_RSA_WITH_AES_128_GCM_SHA256)
```
