...
```
$ playground run -f zendesk-source<use tab key to activate fzf completion (see https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion), otherwise use full path, or relative path> <ZENDESK_URL> <ZENDESK_USERNAME> <ZENDESK_PASSWORD>
```
