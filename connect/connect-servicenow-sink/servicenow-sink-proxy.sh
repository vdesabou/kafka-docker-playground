...
curl -X GET "${SERVICENOW_URL}/api/now/table/u_test_table" --user "admin:$SERVICENOW_PASSWORD" -H 'Accept: application/json' -H 'Content-Type: application/json' -H 'cache-control: no-cache' | jq .
EOF
cat /tmp/result.log
