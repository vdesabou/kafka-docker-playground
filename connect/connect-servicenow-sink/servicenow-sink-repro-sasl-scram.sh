...
${DIR}/../../environment/sasl-scram/start.sh "${PWD}/docker-compose.plaintext.yml"

log "Sending messages to topic test_table"
docker cp ${PWD}/client.properties connect:tmp/client.properties
docker exec -i connect kafka-avro-console-producer --broker-list broker:9092 --property schema.registry.url=http://schema-registry:8081 --topic test_table --producer.config /tmp/client.properties --property value.schema='{"type":"record","name":"myrecord","fields":[{"name":"u_name","type":"string"},
...
curl -X PUT \
     ...
     --data '{
                    ...
                    "reporter.admin.sasl.mechanism" : "SCRAM-SHA-256",
                    "reporter.admin.sasl.jaas.config" : "org.apache.kafka.common.security.scram.ScramLoginModule required  username=\"client\" password=\"client-secret\";",
                    "reporter.admin.security.protocol" : "SASL_PLAINTEXT",
                    "reporter.producer.sasl.mechanism" : "SCRAM-SHA-256",
                    "reporter.producer.sasl.jaas.config" : "org.apache.kafka.common.security.scram.ScramLoginModule required  username=\"client\" password=\"client-secret\";",
                    "reporter.producer.security.protocol" : "SASL_PLAINTEXT",
                    "confluent.topic.bootstrap.servers": "broker:9092",
                    "confluent.topic.replication.factor": "1",
                    "confluent.topic.security.protocol" : "SASL_PLAINTEXT",
                    "confluent.topic.sasl.mechanism": "SCRAM-SHA-256",
                    "confluent.topic.sasl.jaas.config": "org.apache.kafka.common.security.scram.ScramLoginModule required  username=\"client\" password=\"client-secret\";"
          }' \
