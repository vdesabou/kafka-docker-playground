...
```
$ playground run -f jms-solace-source<use tab key to activate [fzf completion](https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion) (otherwise use full path, i.e *not relative path*>
```
...
```
playground topic consume --topic source-messages --min-expected-messages 2 --timeout 60
