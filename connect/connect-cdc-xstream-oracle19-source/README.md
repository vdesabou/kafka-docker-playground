...
Quickly test [Oracle XStream CDC Source Connector](https://docs.confluent.io/kafka-connectors/oracle-xstream-cdc-source/current/overview.html) with Oracle 19c.
