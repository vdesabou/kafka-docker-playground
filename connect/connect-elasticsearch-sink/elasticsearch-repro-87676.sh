...
# [2022-01-10 14:39:37,101] TRACE [elasticsearch-sink|task-0] Adding record to queue (io.confluent.connect.elasticsearch.bulk.BulkProcessor:335)
# [2022-01-10 14:39:37,102] DEBUG [elasticsearch-sink|task-0] Farmer1 Submitting batch of 1 records; 1 unsent and 1 total in-flight records (io.confluent.connect.elasticsearch.bulk.BulkProcessor:189)
# [2022-01-10 14:39:37,110] DEBUG [elasticsearch-sink|task-0] Farmer1 Processing next batch with 1 outstanding batch requests in flight (io.confluent.connect.elasticsearch.bulk.BulkProcessor:151)
# [2022-01-10 14:39:37,115] TRACE [elasticsearch-sink|task-0] Thread1 Executing batch 1 of 1 records with attempt 1/6 (io.confluent.connect.elasticsearch.bulk.BulkProcessor:438)
# [2022-01-10 14:39:37,164] DEBUG [elasticsearch-sink|task-0] Thread1 Bulk request failed; collecting error(s) (io.confluent.connect.elasticsearch.jest.JestElasticsearchClient:549)
# [2022-01-10 14:39:37,167] DEBUG [elasticsearch-sink|task-0] Thread1 Encountered an illegal document error when executing batch 1 of 1 records. Ignoring and will not index record. Error was [{"type":"mapper_parsing_exception","reason":"failed to parse","caused_by":{"type":"not_x_content_exception","reason":"Compressor detection can only be called on some xcontent bytes or compressed xcontent bytes"}}] (io.confluent.connect.elasticsearch.bulk.BulkProcessor:490)
