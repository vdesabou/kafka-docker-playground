...
if [ ! -f ${DIR}/adminclient/target/adminclient-1.0.0-jar-with-dependencies.jar ]
then
...
docker exec adminclient bash -c "java -jar adminclient-1.0.0-jar-with-dependencies.jar"
