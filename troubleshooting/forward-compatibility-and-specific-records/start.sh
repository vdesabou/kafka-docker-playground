...
docker restart consumer-v1

sleep 5

log "reset offset for consumer-v1"
...
log "Run the Java consumer-v1"
docker exec consumer-v1 bash -c "java -jar consumer-v1-1.0.0-jar-with-dependencies.jar" > consumer_after_reset.log 2>&1 &