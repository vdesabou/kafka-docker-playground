...
timeout 60 docker exec broker kafka-console-consumer --bootstrap-server broker:9092 --topic playground_ksql_processing_log --from-beginning --max-messages 1 --consumer.config /tmp/client.properties
