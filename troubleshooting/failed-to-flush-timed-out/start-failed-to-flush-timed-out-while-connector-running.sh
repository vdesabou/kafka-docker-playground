...
playground start-environment --environment plaintext --docker-compose-override-file "${PWD}/docker-compose.plaintext.failed-to-flush-timed-out-while-connector-running.yml"
log "Generating data"
