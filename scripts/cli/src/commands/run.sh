    ...
    do
      ...
      then
        ...
        then
          ...
          then
            ccloud_preview="${ccloud_preview}🌐 ${YELLOW}environment is missing, new environment will be created${NC}\n"
          else
            if [ ! -z "$ENVIRONMENT" ]
            then
          ...
          then
            ccloud_preview="${ccloud_preview}🔋 ${YELLOW}cluster-type is missing, basic will be used${NC}\n"
          else
            if [ ! -z "$CLUSTER_TYPE" ]
            then
          ...
          then
            ccloud_preview="${ccloud_preview}🌤 ${YELLOW}cluster-cloud is missing, aws will be used${NC}\n"
          else
            if [ ! -z "$CLUSTER_CLOUD" ]
            then
          ...
          then
            ccloud_preview="${ccloud_preview}🗺 ${YELLOW}cluster-region is missing, default region for provider will be used${NC}\n"
          else
            if [ ! -z "$CLUSTER_REGION" ]
            then
