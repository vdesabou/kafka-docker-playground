    ...
    do
      ...
      then
        ...
        then
          ...
          # CLUSTER_NAME is set
          #
          ccloud_preview="🌱${YELLOW}CLUSTER_NAME is set, your existing Confluent Cloud cluster will be used...${NC}\n"
      ...
      preview="${ccloud_preview}🚀 number of examples ran so far: $(get_cli_metric nb_runs)\n\n⛳ flag list:\n$flag_string"
