...
if [ -f "$output_dir_abs/analysis-report.html" ]; then
    log "📊 Main Report: $output_dir_abs/analysis-report.html"
    log ""
    log "💡 Open the HTML report in your browser for interactive analysis:"
    log "   open $output_dir_abs/analysis-report.html"
else
