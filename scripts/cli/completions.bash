...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *'config'*)
      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_playground_completions_filter "--help -h clipboard editor folder_zip_or_jar open-ccloud-connector-in-browser")" -- "$cur")
      ;;
