...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *'tcp-proxy'*)
      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_playground_completions_filter "--help -h close-connection delay get-connections start toggle-accept-connections")" -- "$cur" )
      ;;
