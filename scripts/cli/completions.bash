...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *'schema'*)
      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_playground_completions_filter "--help -h delete get get-compatibility get-mode register set-compatibility set-mode set-normalize")" -- "$cur")
      ;;
