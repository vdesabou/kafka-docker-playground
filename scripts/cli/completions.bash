...
_playground_completions() {
  ...
  case "$compline" in
    ...
    'debug'*)
      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_playground_completions_filter "--help -h enable-remote-debugging heap-dump log-level tcp-dump thread-dump")" -- "$cur" )
      ;;
