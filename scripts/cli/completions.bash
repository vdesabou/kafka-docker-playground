...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *'debug'*)
      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_playground_completions_filter "--help -h block-traffic disable-remote-debugging enable-remote-debugging flight-recorder generate-diagnostics heap-analyze heap-dump java-debug jscissors log-level tcp-dump testssl thread-dump")" -- "$cur")
      ;;
