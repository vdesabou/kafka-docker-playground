...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *)
      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_playground_completions_filter "--help --version -h -v bootstrap-reproduction-model connector container enable-remote-debugging get-connector-list get-examples-list-with-fzf get-jmx-metrics get-properties get-topic-list re-run run topic")" -- "$cur" )
      ;;
