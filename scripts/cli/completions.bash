...
_playground_completions() {
  ...
  case "$compline" in
    ...
    'topic'*)
      while read -r; do COMPREPLY+=( "$REPLY" ); done < <( compgen -W "$(_playground_completions_filter "--help -h consume describe display-consumer-offsets get-number-records set-schema-compatibility")" -- "$cur" )
      ;;
