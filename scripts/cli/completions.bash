...
_playground_completions() {
  ...
  case "$compline" in
    ...
    *'ec2'*)
      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_playground_completions_filter "--help -h create delete list open start start-all stop stop-all sync-repro-folder-to-ec2")" -- "$cur")
      ;;
