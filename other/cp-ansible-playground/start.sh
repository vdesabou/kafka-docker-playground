...
if test -z "$(docker images -q cp-ansible-ubuntu:latest)"
then
     echo -e "\033[0;33mBuilding cp-ansible-ubuntu docker image..it can take a while...\033[0m"
     docker build -t cp-ansible-ubuntu .
fi
