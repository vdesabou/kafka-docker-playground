...
docker exec -i connect -e KAFKA_DEBUG="" kafka-console-consumer --bootstrap-server broker:9092 --topic confluent-audit-log-events --consumer.config /tmp/client.properties --from-beginning --max-messages 5