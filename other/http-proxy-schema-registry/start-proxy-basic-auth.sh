...
#         at io.confluent.kafka.formatter.AvroMessageReader$AvroMessageSerializer.serialize(AvroMessageReader.java:172)
#         at io.confluent.kafka.formatter.SchemaMessageReader.readMessage(SchemaMessageReader.java:326)
#         at kafka.tools.ConsoleProducer$.main(ConsoleProducer.scala:50)
#         at kafka.tools.ConsoleProducer.main(ConsoleProducer.scala)
# Caused by: io.confluent.kafka.schemaregistry.client.rest.exceptions.RestClientException: Unexpected character ('<' (code 60)): expected a valid value (JSON String, Number (or 'NaN'/'INF'/'+INF'), Array, Object or token 'null', 'true' or 'false')
