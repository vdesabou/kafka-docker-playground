...
import com.github.vdesabou.IdImpl;
import com.github.vdesabou.IdImpl.Id;
...
public class SimpleProducer {
    ...
    private void start() throws InterruptedException {
        ...
        try (Producer<Id, Customer> producer = new KafkaProducer<>(properties)) {
            long i= 0;
            while (i < nbMessages) {
                ...
                Id id = generator.nextObject(Id.class);
                Customer customer = generator.nextObject(Customer.class);

                ProducerRecord<Id, Customer> record = new ProducerRecord<>(topicName, id, customer);
    ...
    private void sendCallback(ProducerRecord<Id, Customer> record, RecordMetadata recordMetadata, Exception e) {
        if (e == null) {
    ...
    private Map<String, String> defaultProps = Map.of(
            ...
            ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, "io.confluent.kafka.serializers.protobuf.KafkaProtobufSerializer",
