...
```
$ just use <playground run> command and search for start-custom-log4j.sh in this folder
```
...
```
$ just use <playground run> command and search for start-template-log4j.sh in this folder
```
