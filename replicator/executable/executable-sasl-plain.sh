...
docker-compose -f ../../environment/mdc-plaintext/docker-compose.yml -f ../../environment/mdc-sasl-plain/docker-compose.mdc-sasl-plain.yml -f docker-compose.sasl-plain.yml up -d
