...
log "Get subject products_EUROPE-value version in US"
...
timeout 60 docker container exec -i connect-us kafka-avro-console-consumer --bootstrap-server broker-us:9092 --topic products_EUROPE --from-beginning --max-messages 1 --property schema.registry.url=http://schema-registry-us:8081
