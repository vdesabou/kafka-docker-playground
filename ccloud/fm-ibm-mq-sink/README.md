# Fully Managed IBM MQ Sink connector

## Objective

Quickly test [IBM MQ Sink](https://docs.confluent.io/cloud/current/connectors/cc-ibm-mq-sink.html#cc-ibm-mq-sink) connector.
...
```
$ just use <playground run> command and search for fully-managed-ibm-mq-source<use tab key to activate fzf completion (see https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion), otherwise use full path, or correct relative path> .sh in this folder
```
