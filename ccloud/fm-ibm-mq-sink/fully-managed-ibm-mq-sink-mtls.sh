...
mkdir -p ../../ccloud/fm-ibm-mq-sink/security
cd ../../ccloud/fm-ibm-mq-sink/security
...
connector_name="IbmMqSinkMTLS_$USER"
set +e
playground connector delete --connector $connector_name > /dev/null 2>&1
set -e

base64_truststore=$(cat ../../ccloud/fm-ibm-mq-sink/security/kafka.ibmmq.truststore.jks | base64 | tr -d '\n')
base64_keystore=$(cat ../../ccloud/fm-ibm-mq-sink/security/kafka.ibmmq.keystore.jks | base64 | tr -d '\n')
...
playground connector create-or-update --connector $connector_name << EOF
{
    ...
    "mq.tls.keystore.location": "data:text/plain;base64,$base64_keystore",
