# Fully Managed Azure Data Lake Storage Gen2 Sink connector



## Objective

Quickly test [Fully Managed Azure Data Lake Storage Gen2 Sink](https://docs.confluent.io/cloud/current/connectors/cc-azure-datalakeGen2-storage-sink.html) connector.
