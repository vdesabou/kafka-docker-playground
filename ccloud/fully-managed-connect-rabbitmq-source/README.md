# Fully Managed RabbitMQ Source connector
...
```
$ playground run -f fullly-managed-rabbitmq-source<use tab key to activate fzf completion (see https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion), otherwise use full path, or correct relative path>
```
