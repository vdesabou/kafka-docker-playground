...
docker exec -e REST_KEY=$REST_KEY restproxy cp /etc/kafka/secrets/$REST_KEY.key /tmp/$REST_KEY.key
docker exec -e REST_KEY=$REST_KEY restproxy ls -lrt /tmp/$REST_KEY.key
