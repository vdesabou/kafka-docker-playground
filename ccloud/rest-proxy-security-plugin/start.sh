...
docker exec -e REST_KEY=$REST_KEY restproxy ls -lrt /etc/kafka/secrets/$REST_KEY.key
docker exec -e REST_KEY=$REST_KEY restproxy cat /etc/kafka/secrets/$REST_KEY.key
