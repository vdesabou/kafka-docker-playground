...
docker compose -f docker-compose.ssl.yml ${profile_sql_datagen_command} down -v --remove-orphans
docker compose -f docker-compose.ssl.yml ${profile_sql_datagen_command} up -d --quiet-pull
