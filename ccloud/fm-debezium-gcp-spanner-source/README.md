...
Quickly test [Fully Managed Debezium CDC GCP Spanner source](https://docs.confluent.io/cloud/current/connectors/cc-google-spanner-cdc-source-debezium.html) connector.
