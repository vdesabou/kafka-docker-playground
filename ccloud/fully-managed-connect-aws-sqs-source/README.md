# Fully Managed AWS SQS Source connector



## Objective

Quickly test [Fully Managed SQS Connector](https://docs.confluent.io/cloud/current/connectors/cc-amazon-sqs-source.html) connector.
