# Fully Managed MQTT Sink connector



## Objective

Quickly test [MQTT Sink](https://docs.confluent.io/cloud/current/connectors/cc-mqtt-sink.html) connector.
...
```
$ just use <playground run> command and search for fully-managed-mqtt-sink<use tab key to activate fzf completion (see https://kafka-docker-playground.io/#/cli?id=%e2%9a%a1-setup-completion), otherwise use full path, or correct relative path> .sh in this folder
```