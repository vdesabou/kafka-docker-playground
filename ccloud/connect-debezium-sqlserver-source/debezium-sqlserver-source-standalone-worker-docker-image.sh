...
playground start-environment --environment ccloud --docker-compose-override-file "${PWD}/docker-compose.plaintext.standalone-worker-docker-image.yml" --wait-for-control-center
