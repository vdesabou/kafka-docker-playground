# Fully Managed Elasticsearch v2 Sink connector



## Objective

Quickly test [Elasticsearch v2 Sink](https://docs.confluent.io/cloud/current/connectors/cc-elasticsearch-sink-v2/cc-elasticsearch-sink-v2.html) connector.
...
```
$ just use <playground run> command and search for fully-managed-elasticsearch-sink.sh in this folder
```
