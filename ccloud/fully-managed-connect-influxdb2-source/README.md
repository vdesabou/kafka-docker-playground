# Fully Managed InfluxDB 2 Source connector



## Objective

Quickly test [Fully Managed InfluxDB 2 Source](https://docs.confluent.io/cloud/current/connectors/cc-influxdb2-source.html) connector.
