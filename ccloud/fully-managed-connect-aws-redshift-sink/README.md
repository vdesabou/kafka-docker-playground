# Fully Managed AWS Redshift Sink connector



## Objective

Quickly test [Fully Managed AWS Redshift](https://docs.confluent.io/cloud/current/connectors/cc-amazon-redshift-sink.html) connector.
