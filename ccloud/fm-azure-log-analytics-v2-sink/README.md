# Fully Managed Azure Log Analytics V2 Sink connector



## Objective

Quickly test [Fully Managed Azure Log Analytics V2 Sink](https://docs.confluent.io/cloud/current/connectors/cc-azure-log-analytics-sink-v2.html) connector.
