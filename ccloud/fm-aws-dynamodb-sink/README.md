# Fully Managed AWS DynamoDB Sink connector



## Objective

Quickly test [Fully Managed AWS DynamoDB](https://docs.confluent.io/cloud/current/connectors/cc-amazon-dynamo-db-sink.html) connector.
