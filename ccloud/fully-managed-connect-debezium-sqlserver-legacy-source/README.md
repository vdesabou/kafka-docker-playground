# Fully Managed Microsoft SQL Server CDC Source (Debezium) [Legacy] source connector



## Objective

Quickly test [Microsoft SQL Server CDC Source (Debezium) [Legacy]](https://docs.confluent.io/cloud/current/connectors/cc-microsoft-sql-server-source-cdc-debezium.html) connector.
