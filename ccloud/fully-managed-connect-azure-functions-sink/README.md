# Fully Managed Azure Functions Sink connector



## Objective

Quickly test [Fully Managed Azure Functions Sink](https://docs.confluent.io/cloud/current/connectors/cc-azure-functions-sink.html) connector.
