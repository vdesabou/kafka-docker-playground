# Fully-Managed Debezium MariaDB source connector



## Objective

Quickly test [Debezium MariaDB](https://docs.confluent.io/cloud/current/connectors/cc-mariadb-cdc-source-debezium.html#cc-mariadb-source-cdc-debezium-configure-connector) connector.
