# Fully Managed Azure Blob Storage Source connector



## Objective

Quickly test [Fully Managed Azure Blob Storage Source](https://docs.confluent.io/cloud/current/connectors/cc-azure-blob-source.html) connector.
