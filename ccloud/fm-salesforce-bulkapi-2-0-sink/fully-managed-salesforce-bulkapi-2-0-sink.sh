...
set +e
playground topic delete --topic sfdc-pushtopic-leads-bulk-sink-v2
sleep 3
playground topic create --topic sfdc-pushtopic-leads-bulk-sink-v2
set -e
...
playground connector create-or-update --connector $connector_name << EOF
{
     ...
     "kafka.topic": "sfdc-pushtopic-leads-bulk-sink-v2",
...
playground topic consume --topic sfdc-pushtopic-leads-bulk-sink-v2 --min-expected-messages 1 --timeout 60
...
playground connector create-or-update --connector $connector_name2 << EOF
{
     ...
     "kafka.api.key": "$CLOUD_KEY",
     "kafka.api.secret": "$CLOUD_SECRET",
     "topics": "sfdc-pushtopic-leads-bulk-sink-v2",
     "salesforce.object" : "Lead",
