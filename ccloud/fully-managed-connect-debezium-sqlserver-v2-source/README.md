# Fully Managed Microsoft SQL Server CDC Source (Debezium) [v2] source connector



## Objective

Quickly test [Microsoft SQL Server CDC Source (Debezium) v2](https://docs.confluent.io/cloud/current/connectors/cc-microsoft-sql-server-source-cdc-v2-debezium/cc-microsoft-sql-server-source-cdc-v2-debezium.html) connector.
...
```
$ just use <playground run> command and search for debezium-sqlserver-source.sh in this folder
```
