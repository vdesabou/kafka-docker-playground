# Fully Managed Azure Log Analytics Sink connector



## Objective

Quickly test [Fully Managed Azure Log Analytics Sink](https://docs.confluent.io/cloud/current/connectors/cc-azure-log-analytics-sink.html) connector.
