...
playground topic consume --topic orders_new --min-expected-messages 2 --timeout 60
...
playground topic consume --topic orders_new --min-expected-messages 4 --timeout 60
