...
@UdfDescription(name = "formula_custom_logger",
                author = "example",
                version = "1.0.0",
                description = "A custom formula for important business logic.")
public class FormulaUdfCustomLogger {

    private static final Logger log = LoggerFactory.getLogger(FormulaUdfCustomLogger.class);
