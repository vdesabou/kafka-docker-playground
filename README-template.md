...
:connect/connect-active-mq-sink:
...
:connect/connect-active-mq-source:
...
:connect/connect-aws-cloudwatch-logs-source:
...
:connect/connect-aws-cloudwatch-metrics-sink:
...
:connect/connect-aws-dynamodb-sink:
...
:connect/connect-aws-kinesis-source:
...
:connect/connect-aws-lambda-sink:
...
:connect/connect-azure-blob-storage-sink:
...
:connect/connect-azure-cosmosdb-sink:
...
:connect/connect-azure-cosmosdb-source:
...
:connect/connect-azure-data-lake-storage-gen1-sink:
...
:connect/connect-azure-data-lake-storage-gen2-sink:
...
:connect/connect-azure-functions-sink:
...
:connect/connect-azure-cognitive-search-sink:
...
:connect/connect-azure-service-bus-source:
...
:connect/connect-azure-sql-data-warehouse-sink:
...
:connect/connect-cassandra-sink:
...
:connect/connect-couchbase-sink:
...
:connect/connect-couchbase-source:
...
:connect/connect-debezium-mysql-source:
...
:connect/connect-debezium-postgresql-source:
...
:connect/connect-debezium-mongodb-source:
...
:connect/connect-datadiode-source-sink:
...
:connect/connect-datadog-metrics-sink:
...
:connect/connect-elasticsearch-sink:
...
:connect/connect-filepulse-source:
...
:connect/connect-pivotal-gemfire-sink:
...
:connect/connect-influxdb-source:
...
:connect/connect-jdbc-ibmdb2-sink:
...
:connect/connect-jdbc-ibmdb2-source:
...
:connect/connect-jdbc-mysql-sink:
...
:connect/connect-jdbc-oracle11-sink:
...
:connect/connect-jdbc-oracle19-sink:
...
:connect/connect-jdbc-postgresql-sink:
...
:connect/connect-jdbc-mysql-source:
...
:connect/connect-jdbc-oracle11-source:
...
:connect/connect-jdbc-oracle19-source:
...
:connect/connect-jdbc-postgresql-source:
...
:connect/connect-jdbc-vertica-sink:
...
:connect/connect-jms-solace-sink:
...
:connect/connect-marketo-source:
...
:connect/connect-mongodb-source:
...
:connect/connect-pagerduty-sink:
...
:connect/connect-prometheus-sink:
...
:connect/connect-rabbitmq-source:
...
:connect/connect-salesforce-bulkapi-sink:
...
:connect/connect-salesforce-bulkapi-source:
...
:connect/connect-salesforce-cdc-source:
...
:connect/connect-salesforce-platform-events-sink:
...
:connect/connect-salesforce-platform-events-source:
...
:connect/connect-salesforce-pushtopics-source:
...
:connect/connect-salesforce-sobject-sink:
...
:connect/connect-servicenow-sink:
...
:connect/connect-servicenow-source:
...
:connect/connect-spool-dir-source:
...
:connect/connect-zendesk-source:
